...
export default function CategoryGrid({ categories, accounts }: CategoryGridProps) {
    const [activeType, setActiveType] = useState<'expense' | 'income'>('expense');
    const [interactionMode, setInteractionMode] = useState<'entry' | 'edit'>('entry');
    ...
    const createCategoryUrl = CategoryController.create.url({ query: { type: activeType } });
        ...
        <section className="rounded-2xl border bg-card p-4 shadow-xs sm:p-5">
                ...
                <div className="flex flex-col gap-2 sm:items-end">
                    ...
                    >
                        ...
                        <button
                            ...
                            className={`grow rounded-r-lg rounded-l px-3 py-1.5 text-xs font-semibold transition-colors ${
                                activeType === 'income'
            ...
            <div className="grid grid-cols-3 gap-2">
                    ...
                    interactionMode === 'edit' ? (
                        ...
                        >
                            ...
                            <div className="text-center">
                                <p className="text-xs font-semibold leading-none">{formatInteger(getNumericTotal(category))}</p>
                            </div>
                        </Link>
                    ) : (
                        <button
                ...
                {interactionMode === 'edit' ? (
                    ...
                    >
                        <p className="truncate text-xs font-medium leading-tight">Add category</p>
